...
#PARECE SER DETERMINÍSTICO (NECESSÁRIO TESTAR POIS UTILIZA UMA ÁRVORE DE DECISÃO)
def MAE_cal(max_leaf_nodes,train_X,valid_X,train_Y,valid_Y):
    ...
    @deterministic
    def f1(valid_Y, val_prediction):
        return mean_absolute_error(valid_Y, val_prediction)
    return f1(valid_Y, val_prediction)
